...
<head>
  ...
  <title>ZakMas Admin - Reservation</title>
            ...
            <tbody>
              ...
              foreach ($tabel as $u) {
                ...
                <tr>
                  ...
                  <td><?php echo $u->durasi . " Jam" ?></td>
                  <td colspan="2">
                    <a type="button" class="btn btn-primary text-white" href="<?= base_url('PemesananData/edit/') . $u->id ?>">Edit</a>
                    <a type="button" class="btn btn-danger text-white" href="<?= base_url('PemesananData/delete/') . $u->id ?>">Hapus</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
