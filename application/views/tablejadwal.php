            ...
            <tbody>
              ...
              foreach ($tabel as $u) {
                ...
                <tr>
                  ...
                  <td colspan="2">
                    <a type="button" class="btn btn-primary text-white" href="<?= base_url('JadwalData/edit/') . $u->id_jadwal ?>">Edit</a>
                    <a type="button" class="btn btn-danger text-white" href="<?= base_url('JadwalData/delete/') . $u->id_jadwal ?>">Hapus</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
          <a href="<?php echo base_url('JadwalData') ?>" class="btn btn-primary">Add Jadwal</a>
        </div>
        <!-- /.container-fluid -->
