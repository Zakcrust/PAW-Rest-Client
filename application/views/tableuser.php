            ...
            <tbody>
              ...
              foreach ($tabel as $u) {
                ...
                <tr>
                  ...
                  <td colspan="2">
                    <a type="button" class="btn btn-primary text-white" href="<?= base_url('UserData/edit/') . $u->id ?>">Ganti Email/Password</a>
                    <a type="button" class="btn btn-danger text-white" href="<?= base_url('UserData/delete/') . $u->id ?>">Hapus</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
