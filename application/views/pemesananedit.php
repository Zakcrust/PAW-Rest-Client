            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="<?php echo base_url('UserData/update') ?>" method="post">
                        ...
                        <input type="hidden" name="token" value="<?php echo $pemesanan->token ?>">
                        <div class="form-group">
                            <label for="exampleInputEmail1">ID Jadwal</label>
                            <input type="id_jadwal" name="id_jadwal" disabled="disable" class="form-control" value="<?php echo $pemesanan->id_jadwal ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">ID User</label>
                            <input name="id_user" type="text" disabled="disable" class="form-control" id="exampleInputPassword1" value="<?php echo $pemesanan->id_user ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama User</label>
                            <input name="nama_user" type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $pemesanan->nama_user ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Durasi</label>
                            <input name="durasi" type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $pemesanan->durasi ?>" required>
                        </div>
