...
<head>
  ...
  <title>ZakMas Admin - Login</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" action="<?php echo base_url('AdminMain/login') ?>" method="post">
            ...
            <!-- <div style="color :red"><?php $this->load->library('session'); echo $this->session->flashdata('data_invalid') ?></div> -->
          </div>
        </div>
