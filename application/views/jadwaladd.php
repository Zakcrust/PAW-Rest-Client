        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="<?php echo base_url('JadwalData/add') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="jam" type="time" class="form-control" id="exampleInputPassword1" placeholder="00:00" required>
                        </div>
