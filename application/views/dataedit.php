        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="<?php echo base_url('User/dataupdate') ?>" method="post">
                        <div class="form-group">
                            <input type="hidden" name="id" value="<?php echo $userdata->id ?>">
                            <label>Random Text</label>
                            <input name="random_text" type="text" class="form-control" placeholder="Text" value="<?php echo $userdata->random_text ?>" required>
                        </div>
